...
-- Design Ports Information
-- OUT_C1	=>  Location: PIN_A18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- OUT_C2	=>  Location: PIN_A17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- OUT_C3	=>  Location: PIN_E14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- IN_S2	=>  Location: PIN_A20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- IN_S1	=>  Location: PIN_A19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- CLK	=>  Location: PIN_N5,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF FMS_Prova IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL ww_IN_S1 : std_logic;
SIGNAL ww_IN_S2 : std_logic;
...
SIGNAL \OUT_C1~output_o\ : std_logic;
SIGNAL \OUT_C2~output_o\ : std_logic;
SIGNAL \OUT_C3~output_o\ : std_logic;
...
\OUT_C1~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
\OUT_C2~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\OUT_C3~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
-- Equation(s):
-- \CHIP1|Y~1_combout\ = (\CHIP1|Add0~12_combout\ & ((!\CHIP1|Equal0~6_combout\) # (!\CHIP1|Equal0~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \CHIP1|Equal0~4_combout\,
	datac => \CHIP1|Add0~12_combout\,
...
-- Equation(s):
-- \CHIP1|Y~0_combout\ = (\CHIP1|Add0~16_combout\ & ((!\CHIP1|Equal0~6_combout\) # (!\CHIP1|Equal0~4_combout\)))
...
-- Equation(s):
-- \CHIP1|Y~2_combout\ = (\CHIP1|Add0~18_combout\ & ((!\CHIP1|Equal0~4_combout\) # (!\CHIP1|Equal0~6_combout\)))
...
-- Equation(s):
-- \CHIP1|Y~3_combout\ = (\CHIP1|Add0~22_combout\ & ((!\CHIP1|Equal0~6_combout\) # (!\CHIP1|Equal0~4_combout\)))
...
-- Equation(s):
-- \CHIP1|Y~4_combout\ = (\CHIP1|Add0~28_combout\ & ((!\CHIP1|Equal0~6_combout\) # (!\CHIP1|Equal0~4_combout\)))
...
-- Equation(s):
-- \CHIP1|Equal0~3_combout\ = (!\CHIP1|Y\(12) & (!\CHIP1|Y\(15) & (\CHIP1|Y\(14) & !\CHIP1|Y\(13))))
...
-- Equation(s):
-- \CHIP1|Equal0~2_combout\ = (!\CHIP1|Y\(10) & (\CHIP1|Y\(11) & (\CHIP1|Y\(9) & \CHIP1|Y\(0))))
...
-- Equation(s):
-- \CHIP1|Equal0~1_combout\ = (\CHIP1|Y\(1) & (\CHIP1|Y\(3) & (\CHIP1|Y\(2) & \CHIP1|Y\(4))))
...
-- Equation(s):
-- \CHIP1|Equal0~0_combout\ = (\CHIP1|Y\(5) & (!\CHIP1|Y\(7) & (\CHIP1|Y\(8) & !\CHIP1|Y\(6))))
...
-- Equation(s):
-- \CHIP1|Equal0~4_combout\ = (\CHIP1|Equal0~3_combout\ & (\CHIP1|Equal0~2_combout\ & (\CHIP1|Equal0~1_combout\ & \CHIP1|Equal0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \CHIP1|Equal0~3_combout\,
	datab => \CHIP1|Equal0~2_combout\,
	datac => \CHIP1|Equal0~1_combout\,
	datad => \CHIP1|Equal0~0_combout\,
...
-- Equation(s):
-- \CHIP1|Y~5_combout\ = (\CHIP1|Add0~36_combout\ & ((!\CHIP1|Equal0~4_combout\) # (!\CHIP1|Equal0~6_combout\)))
...
-- Equation(s):
-- \CHIP1|Y~6_combout\ = (\CHIP1|Add0~38_combout\ & ((!\CHIP1|Equal0~6_combout\) # (!\CHIP1|Equal0~4_combout\)))
...
-- Equation(s):
-- \CHIP1|Equal0~5_combout\ = (\CHIP1|Y\(19) & (!\CHIP1|Y\(16) & (!\CHIP1|Y\(17) & \CHIP1|Y\(18))))
...
-- Equation(s):
-- \CHIP1|Y~7_combout\ = (\CHIP1|Add0~44_combout\ & ((!\CHIP1|Equal0~4_combout\) # (!\CHIP1|Equal0~6_combout\)))
...
-- Equation(s):
-- \CHIP1|Equal0~6_combout\ = (!\CHIP1|Y\(21) & (!\CHIP1|Y\(20) & (\CHIP1|Equal0~5_combout\ & \CHIP1|Y\(22))))
...
-- Equation(s):
-- \CHIP1|X~0_combout\ = \CHIP1|X~q\ $ (((\CHIP1|Equal0~6_combout\ & \CHIP1|Equal0~4_combout\)))
...
\IN_S2~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
...
\IN_S1~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
...
-- Equation(s):
-- \CHIP2|AUX~12_combout\ = ((\IN_S1~input_o\) # (!\CHIP2|AUX.EST_GP~q\)) # (!\IN_S2~input_o\)
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_H1~q\);

-- Location: LCCOMB_X65_Y53_N6
\CHIP2|Selector0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|Selector0~0_combout\ = ((\IN_S2~input_o\ & (!\IN_S1~input_o\ & \CHIP2|AUX.EST_GB~q\))) # (!\CHIP2|AUX.EST_H1~q\)
...
PORT MAP (
	dataa => \IN_S2~input_o\,
	datab => \IN_S1~input_o\,
	datac => \CHIP2|AUX.EST_GB~q\,
	datad => \CHIP2|AUX.EST_H1~q\,
	combout => \CHIP2|Selector0~0_combout\);

-- Location: FF_X65_Y53_N7
\CHIP2|AUX.EST_GB\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_GB~q\);

-- Location: LCCOMB_X65_Y53_N0
\CHIP2|AUX~13\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|AUX~13_combout\ = (\IN_S1~input_o\ & \CHIP2|AUX.EST_GB~q\)
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_H5~q\);

-- Location: LCCOMB_X65_Y53_N12
\CHIP2|AUX~14\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|AUX~14_combout\ = (!\IN_S2~input_o\ & (!\IN_S1~input_o\ & \CHIP2|AUX.EST_GB~q\))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_H2~q\);

-- Location: LCCOMB_X65_Y53_N10
\CHIP2|Selector1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|Selector1~0_combout\ = (\CHIP2|AUX.EST_H4~q\) # ((\CHIP2|AUX.EST_H2~q\) # ((!\IN_S1~input_o\ & \CHIP2|AUX.EST_PA~q\)))
...
PORT MAP (
	dataa => \IN_S1~input_o\,
	datab => \CHIP2|AUX.EST_H4~q\,
	datac => \CHIP2|AUX.EST_PA~q\,
	datad => \CHIP2|AUX.EST_H2~q\,
	combout => \CHIP2|Selector1~0_combout\);

-- Location: FF_X65_Y53_N11
\CHIP2|AUX.EST_PA\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_PA~q\);

-- Location: LCCOMB_X65_Y53_N2
\CHIP2|AUX~15\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|AUX~15_combout\ = (\IN_S1~input_o\ & \CHIP2|AUX.EST_PA~q\)
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_H3~q\);

-- Location: LCCOMB_X65_Y53_N18
\CHIP2|Selector2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|Selector2~0_combout\ = (\CHIP2|AUX.EST_H5~q\) # ((\CHIP2|AUX.EST_H3~q\) # ((\IN_S1~input_o\ & \CHIP2|AUX.EST_GP~q\)))
...
PORT MAP (
	dataa => \IN_S1~input_o\,
	datab => \CHIP2|AUX.EST_H5~q\,
	datac => \CHIP2|AUX.EST_GP~q\,
	datad => \CHIP2|AUX.EST_H3~q\,
	combout => \CHIP2|Selector2~0_combout\);

-- Location: FF_X65_Y53_N19
\CHIP2|AUX.EST_GP\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_GP~q\);

-- Location: LCCOMB_X65_Y53_N24
\CHIP2|AUX~11\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|AUX~11_combout\ = (!\IN_S2~input_o\ & (!\IN_S1~input_o\ & \CHIP2|AUX.EST_GP~q\))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CHIP2|AUX.EST_H4~q\);

-- Location: LCCOMB_X65_Y53_N26
\CHIP2|WideNor0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|WideNor0~combout\ = (\CHIP2|AUX.EST_H4~q\) # ((\CHIP2|AUX.EST_GP~q\) # (!\CHIP2|AUX.EST_H1~q\))
...
-- Equation(s):
-- \CHIP2|WideNor1~combout\ = (\CHIP2|AUX.EST_H5~q\) # ((\CHIP2|AUX.EST_H2~q\) # (\CHIP2|AUX.EST_GB~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \CHIP2|AUX.EST_H5~q\,
	datab => \CHIP2|AUX.EST_H2~q\,
	datad => \CHIP2|AUX.EST_GB~q\,
	combout => \CHIP2|WideNor1~combout\);

-- Location: LCCOMB_X65_Y53_N16
\CHIP2|WideOr3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|WideOr3~0_combout\ = (\CHIP2|AUX.EST_H5~q\) # ((\CHIP2|AUX.EST_GB~q\) # ((\CHIP2|AUX.EST_GP~q\) # (!\CHIP2|AUX.EST_H1~q\)))
...
PORT MAP (
	dataa => \CHIP2|AUX.EST_H5~q\,
	datab => \CHIP2|AUX.EST_GB~q\,
	datac => \CHIP2|AUX.EST_GP~q\,
	datad => \CHIP2|AUX.EST_H1~q\,
	combout => \CHIP2|WideOr3~0_combout\);

-- Location: LCCOMB_X65_Y53_N4
\CHIP2|WideOr4~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \CHIP2|WideOr4~0_combout\ = (\CHIP2|AUX.EST_GP~q\) # ((\CHIP2|AUX.EST_PA~q\) # ((\CHIP2|AUX.EST_H2~q\) # (!\CHIP2|AUX.EST_H1~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \CHIP2|AUX.EST_GP~q\,
	datab => \CHIP2|AUX.EST_PA~q\,
	datac => \CHIP2|AUX.EST_H2~q\,
	datad => \CHIP2|AUX.EST_H1~q\,
...
-- Equation(s):
-- \CHIP2|WideOr5~0_combout\ = (\CHIP2|AUX.EST_GP~q\) # ((\CHIP2|AUX.EST_H3~q\) # ((\CHIP2|AUX.EST_H2~q\) # (\CHIP2|AUX.EST_GB~q\)))
...
-- Equation(s):
-- \CHIP3|Mux6~0_combout\ = (\CHIP2|WideOr3~0_combout\ & (\CHIP2|WideOr4~0_combout\ & !\CHIP2|WideOr5~0_combout\))
...
-- Equation(s):
-- \CHIP3|Mux5~0_combout\ = (\CHIP2|WideOr3~0_combout\ & (\CHIP2|WideOr4~0_combout\ & !\CHIP2|WideOr5~0_combout\)) # (!\CHIP2|WideOr3~0_combout\ & ((\CHIP2|WideOr5~0_combout\)))
...
-- Equation(s):
-- \CHIP3|Mux4~0_combout\ = (\CHIP2|WideOr3~0_combout\ & ((!\CHIP2|WideOr5~0_combout\))) # (!\CHIP2|WideOr3~0_combout\ & (!\CHIP2|WideOr4~0_combout\))
...
-- Equation(s):
-- \CHIP3|Mux3~0_combout\ = (\CHIP2|WideOr3~0_combout\ & (!\CHIP2|WideOr4~0_combout\)) # (!\CHIP2|WideOr3~0_combout\ & ((\CHIP2|WideOr5~0_combout\)))
...
-- Equation(s):
-- \CHIP3|Mux1~0_combout\ = (\CHIP2|WideOr3~0_combout\ & !\CHIP2|WideOr4~0_combout\)
...
-- Equation(s):
-- \CHIP3|Mux0~0_combout\ = (\CHIP2|WideOr3~0_combout\ & (\CHIP2|WideOr4~0_combout\ $ (\CHIP2|WideOr5~0_combout\))) # (!\CHIP2|WideOr3~0_combout\ & (!\CHIP2|WideOr4~0_combout\ & !\CHIP2|WideOr5~0_combout\))
...
ww_OUT_C1 <= \OUT_C1~output_o\;

ww_OUT_C2 <= \OUT_C2~output_o\;

ww_OUT_C3 <= \OUT_C3~output_o\;
